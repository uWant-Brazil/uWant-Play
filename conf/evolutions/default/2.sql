...
insert into users (id,login,password,mail,name,birthday,since,gender,status,modified_at,picture_id) values (nextVal('user_id_seq'),'zeus','0limp0','zeus@olimpo.god.com','Zeus Cronos da Silva','1000-09-01 00:00:00.00',now(),0,0,now(),(select id from multimedia where file_name = 'zeus.png'));
...
insert into product (id,name,modified_at,multimedia) values (nextVal('product_id_seq'),'Biscoito Treloso',now(),(select id from multimedia where file_name = 'treloso.jpg'));
...
insert into product (id,name,nick_name,modified_at,multimedia) values (nextVal('product_id_seq'),'Astes flexíveis','Cotonete',now(),(select id from multimedia where file_name = 'cotonete.jpg'));
...
insert into product (id,name,modified_at,multimedia) values (nextVal('product_id_seq'),'SmartTV',now(),(select id from multimedia where file_name = 'smarttv.jpg'));
...
insert into product (id,name,modified_at,multimedia) values (nextVal('product_id_seq'),'Camisa do Tabajara FC',now(),(select id from multimedia where file_name = 'tabajara.jpg'));
