...
(function(a){
    a.fn.amazon_scroller=function(p){
        ...
        var n=p&&p.scroller_images_height?p.scroller_images_height:"200";
        ...
        function s_s_nav(a,d){
            ...
            a.children("li").css("width","45px");
            a.children("li").css("height","96px");
            a.children("li").css('background-image','url("'+d+'img_uwant_seta.png")');
